...
def update_issue_counter(issue_counter_repo, token, next_number):
...
def update_issue_title(repo, issue_number, token, next_number, issue_title):
    issue_number_formatted = f"Y24-{next_number:03d}"
...
if __name__ == "__main__":
    ...
    update_issue_counter(issue_counter_repo, issue_gen_token, next_number)
    update_issue_title(repo, issue_number, github_token, next_number, issue_title)
